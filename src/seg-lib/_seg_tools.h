...
template <class OldType, class NewType> NIFTYSEG_WINEXPORT
	void ConsecutivelyConnectComp(void * Old, void * New, ImageSize * Currentsize,bool spheric);

template <class OldType, class NewType> NIFTYSEG_WINEXPORT 
	void Close_Forground_ConnectComp(void * Old, void * New, ImageSize * Currentsize);

template <class NewType> NIFTYSEG_WINEXPORT
	int getValueNeighbours(void * New,long index,int *dimensions,bool spheric);

template <class NewType> NIFTYSEG_WINEXPORT
	void updateNeighbours(void * New,long index,int *dimensions,bool spheric);

NIFTYSEG_WINEXPORT bool allEqual(long x,long y,long z);
NIFTYSEG_WINEXPORT bool allEqual4D(long x,long y,long z,long t);
